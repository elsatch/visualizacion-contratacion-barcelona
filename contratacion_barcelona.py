...
st.plotly_chart(px.histogram(df, x='Tipo_entidad', y='Número', color='Tipo_entidad', title='Número de contratos por entidad'))
...
st.plotly_chart(px.treemap(df, path=['Tipo_entidad', 'Nombre_entidad','Tipo de contrato','Procedimiento'], values='Importe', color='Importe', color_continuous_scale='RdBu', title='Contratos realizados por el Ayuntamiento de Barcelona en 2021 (por importe y tipo de entidad)'))

st.subheader("¡Continuamos!")
st.write('Ahora que hemos visto cómo se distribuyen los importes es hora de aprender más sobre estos contratos. Para ello, puedes pasar a la siguiente página en el menú de la esquina superior izquierda')