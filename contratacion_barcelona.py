...
st.plotly_chart(px.treemap(df, path=['Tipo_entidad', 'Nombre_entidad','Tipo de contrato','Procedimiento'], values='Importe', color='Importe', color_continuous_scale='RdBu', title='Contratos realizados por el Ayuntamiento de Barcelona en 2021 agrupados'))
